...
/**
 *
 * An improvement for ASM class reader. ASM class reader reads the whole class
 * into structured data like ClassNode MethodNode But to build a type graph we
 * only need to know class name, parent class name, interfaces name and whether
 * it has a public non-arg default constructor (instantiable) This class skip
 * most parts that are not necessary and parse only the information above
 *
 * And also it use shared buffer to load classes which makes it faster in our
 * performance test
 *
...
public class FastClassIndexReader {
	...
	/**
	 * Read class file content into shared buffer from input stream Stream won't be
	 * closed
	 * 
	 * @param is
	 * @throws IOException
	...
	/**
	 * read class metadata, class name, parent name, interfaces name, is
	 * instantiable(has public non-arg constructor) or not
	 * 
